...
public:
    ...
    void ApplyWrites(TxnProtoExt *txn, StorageManager *manager);
...
private:
    ...
    void SendTxnPtr(socket_t *socket, TxnProtoExt *txn);
    TxnProtoExt *GetTxnPtr(socket_t *socket, zmq::message_t *msg);
    ...
    // they have requested.
    std::deque<TxnProtoExt *> *ready_txns_;
    ...
    AtomicQueue<TxnProtoExt *> *txns_queue;
    AtomicQueue<TxnProtoExt *> *done_queue;
