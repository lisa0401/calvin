...
class LockManager {
 public:
  ...
  virtual int Lock(TxnProtoExt* txn) = 0;
  ...
  //     queue.
  virtual void Release(const Key& key, TxnProtoExt* txn) = 0;
  virtual void Release(TxnProtoExt* txn) = 0;
  ...
  virtual LockMode Status(const Key& key, vector<TxnProtoExt*>* owners) = 0;
};
